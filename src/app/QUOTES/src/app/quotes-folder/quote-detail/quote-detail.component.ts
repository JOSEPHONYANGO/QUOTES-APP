...
export class QuoteDetailComponent implements OnInit {
  ...
  //   date: Date
  quotes:any=[{
    id:1,author:"",title:"",quote:"",upvote:0,downvote:0,date:Date.now()
  }]
  first!:number;
    last!:number;
    count!:number;
